...
class Country:
    ...
    latitude: float
    longitude: float
    frankfurter_supported: bool = True
...
COUNTRIES: tuple[Country, ...] = (
    ...
    Country("EUR", "Eurozone", "EUR", "Europe", 50.9, 4.4, True, "EMU"),
    ...
    Country("EGY", "Egypt", "EGP", "Africa", 30.0, 31.2, False),
    Country("NGA", "Nigeria", "NGN", "Africa", 9.1, 7.5, False),
    ...
    Country("ARG", "Argentina", "ARS", "South America", -34.6, -58.4, False),
